...
| ----------------- | ----------------------------- | ------------- | ------ | ---------------------------------- | ---------- | --- |
| **AUTH**          |
| F001              | User Registration             | Auth          | ❌     | /register                          | Medium     | -   |
| F002              | User Login                    | Auth          | ❌     | /login                             | Medium     | -   |
| F003              | Password Reset                | Auth          | ❌     | /forgot-password                   | Medium     | -   |
| F004              | WebAuthn/Passkey Login        | Auth          | ❌     | /api/webauthn/login/\*             | High       | -   |
| F005              | Passkey Management            | Auth          | ❌     | /settings + /api/webauthn/passkeys | Medium     | -   |
| F006              | Admin Login                   | Auth          | ❌     | /admin-login                       | Low        | -   |
| **DASHBOARD**     |
