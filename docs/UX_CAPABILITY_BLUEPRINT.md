...
*This document is the authoritative contract for UI redesign. All UI implementations must conform to these specifications. Deviations require explicit approval and contract amendment.*
