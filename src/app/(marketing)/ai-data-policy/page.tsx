  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 md:px-6">
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--muted)]">
        <li>
          <strong>OCR (Optical Character Recognition):</strong> Skeniranje i prepoznavanje teksta iz
          slika računa i troškova.
        </li>
        <li>
        ...
        <li>
          <strong>AI preporuke:</strong> Analiza podataka radi identifikacije ušteda i optimizacija.
        </li>
      </ul>
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--muted)]">
        <li>
          <strong>Korisnička kontrola:</strong> Sve AI prijedloge treba ručno potvrditi; AI ne radi
          promjene bez korisničke ovlasti.
        </li>
        <li>
      ...
      <p className="mt-3 text-sm text-[var(--muted)]">
        Svi prijenosi podataka prema AI pružateljima usluga obavljaju se putem sigurnih HTTPS veza.
        Prijenosi se mogu logirati radi praćenja korištenja i sigurnosti.
      </p>
