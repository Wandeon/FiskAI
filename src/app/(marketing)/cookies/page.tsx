  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 md:px-6">
      ...
      <p className="mt-3 text-sm text-[var(--muted)]">
        Kolačići su male tekstualne datoteke koje se pohranjuju na vašem uređaju kada posjetite web
        stranicu. Oni pomažu u poboljšanju korisničkog iskustva i pružanju funkcionalnosti.
      </p>
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--muted)]">
        ...
        <li>
          <strong>Sesija kolačići:</strong> Pohranjuju informacije o vašoj trenutnoj sesiji dok ste
          prijavljeni.
        </li>
        <li>
          <strong>Analitički kolačići:</strong> Kako bismo poboljšali našu uslugu, možemo koristiti
          alate za analitiku (npr. PostHog) koji koriste kolačiće za prikupljanje anonimiziranih
