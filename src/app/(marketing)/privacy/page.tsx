  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 md:px-6">
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--muted)]">
        ...
        <li>
          <strong>Komunikacija:</strong> poruke koje nam šaljete putem podrške ili kontakt obrazaca
        </li>
      </ul>
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--muted)]">
        ...
        <li>
          <strong>Tehnički podaci:</strong> IP adresa, vrsta preglednika, operativni sustav, uređaj
        </li>
        <li>
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--muted)]">
        ...
        <li>
          <strong>Komunikacija:</strong> slanje obavijesti o računu, novostima, tehničkim problemima
        </li>
        <li>
      ...
      <p className="mt-3 text-sm text-[var(--muted)]">
        ...
        kategorizacija troškova). Ova obrada je <strong>opcionalna</strong> i možete je onemogućiti
        u postavkama.
      </p>
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--muted)]">
        <li>AI obrada se vrši putem EU-baziranih pružatelja usluga (OpenAI API, EU regija)</li>
        <li>
          Vaši podaci se <strong>ne koriste za treniranje AI modela</strong> bez vašeg eksplicitnog
          pristanka
        </li>
        <li>AI prijedlozi su uvijek prikazani kao prijedlozi - vi donosite konačnu odluku</li>
        <li>
          Detalji o AI obradi dostupni su u našoj{" "}
          <Link href="/ai-data-policy" className="text-blue-700 hover:underline">
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--muted)]">
        ...
        <li>
          <strong>Enkripcija:</strong> podaci su šifrirani u mirovanju (AES-256) i u prijenosu (TLS
          1.3)
        </li>
        <li>
      ...
      <p className="mt-3 text-sm text-[var(--muted)]">Kao ispitanik u EU imate sljedeća prava:</p>
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--muted)]">
        <li>
      ...
      <p className="mt-4 text-sm text-[var(--muted)]">
        ...
        <a href="mailto:gdpr@fiskai.hr" className="text-blue-700 hover:underline">
          gdpr@fiskai.hr
        </a>
      ...
      <p className="mt-3 text-sm text-[var(--muted)]">
        Možemo povremeno ažurirati ovu politiku privatnosti. O značajnim promjenama obavijestit ćemo
        vas putem emaila ili obavijesti u aplikaciji najmanje 30 dana prije stupanja na snagu.
      </p>
