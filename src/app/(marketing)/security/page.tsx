          ...
          <div className="rounded-lg border border-[var(--border)] bg-[var(--surface)] p-6">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Najmanje privilegije:</strong> multi-tenant izolacija, role-based pristupi
                  po tvrtki.
                </span>
              </li>
              <li className="flex items-start gap-2">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-2">
                  <a href="/status" className="text-blue-700 hover:underline text-sm font-medium">
                    Status sustava
                  </a>
                  <a
                    href="/api/health"
          ...
          <div className="rounded-lg border border-[var(--border)] bg-[var(--surface)] p-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div>
                ...
                <p className="text-[var(--muted)]">
                  Email:{" "}
                  <a href="mailto:security@fiskai.hr" className="text-blue-700 hover:underline">
                    security@fiskai.hr
                  </a>
                </p>
                <p className="text-xs text-[var(--muted)] mt-1">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2 mt-2">
                  <Link href="/privacy" className="text-blue-700 hover:underline text-sm">
                    Politika privatnosti
                  </Link>
                  <Link href="/ai-data-policy" className="text-blue-700 hover:underline text-sm">
                    AI politika podataka
                  </Link>
                  <Link href="/dpa" className="text-blue-700 hover:underline text-sm">
                    DPA (Obrada podataka)
                  </Link>
                  <Link href="/cookies" className="text-blue-700 hover:underline text-sm">
                    Politika kolačića
                  </Link>
                </div>
              </div>
