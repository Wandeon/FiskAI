...
export function InvoiceSummary({
  ...
  return (
    <div
      className={cn(
        "bg-white rounded-xl border border-gray-100 shadow-sm sticky top-20",
        className
      )}
    >
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {buyer?.oib && <p className="text-xs text-gray-500">OIB: {buyer.oib}</p>}
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm font-medium text-gray-900">{invoiceNumber || "Automatski"}</p>
          </div>
        </div>
          ...
          <div className="space-y-2 text-sm text-gray-600">
            {lines.slice(0, 3).map((line, i) => (
              <div key={i} className="flex justify-between gap-3">
                ...
                <span
                  className="font-medium text-gray-900 tabular-nums flex-shrink-0"
            ...
            {lines.length > 3 && (
              <p className="text-xs text-gray-400">+{lines.length - 3} više...</p>
            )}
          </div>
        </div>
