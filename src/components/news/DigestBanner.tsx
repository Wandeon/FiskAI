  ...
  return (
    <HoverScale scale={1.02}>
      <Link href={`/vijesti/${slug}`} className="group mb-12 block">
        <GlassCard className="border-cyan-500/30 bg-gradient-to-r from-accent/10 to-chart-2/10 transition-all hover:border-cyan-500/50 hover:from-accent/20 hover:to-chart-2/20">
