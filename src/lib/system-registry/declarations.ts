...
export const WORKER_COMPONENTS: SystemComponent[] = [
  {
    ...
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/orchestrator.worker.ts",
    dependencies: [
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/sentinel.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/extractor.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/ocr.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/composer.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/reviewer.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/scheduler.service.ts",
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/releaser.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/arbiter.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
  ...
  },
  {
    ...
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef:
      "external:fiskai-workers/src/lib/regulatory-truth/workers/continuous-drainer.worker.ts",
    dependencies: [{ componentId: "store-redis", type: "HARD" }],
    criticalPaths: ["path-rtl-pipeline"],
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/content-sync.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/article.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
  ...
  },
  {
    ...
    owner: "team:ai",
    docsRef: "docs/01_ARCHITECTURE/REGULATORY_TRUTH_LAYER.md",
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/embedding.worker.ts",
    dependencies: [
      { componentId: "store-redis", type: "HARD" },
...
export const QUEUE_COMPONENTS: SystemComponent[] = [
  {
    ...
    owner: "team:ai",
    docsRef: null,
    codeRef: "external:fiskai-workers/src/lib/regulatory-truth/workers/queues.ts",
    dependencies: [{ componentId: "store-redis", type: "HARD" }],
    criticalPaths: ["path-rtl-pipeline"],
